...
export const DEST_MAPPING: Record<string, string> = {
  TOK: "Tokyo",
  PAR: "Paris",
  SFO: "San Francisco",
  LAX: "Los Angeles",
...
const PASSENGER_COUNTS: Record<string, number> = {
 ...
 */
function generatePassengers(): Passenger[] {
...
export const PASSENGERS_DATA: Passenger[] = generatePassengers();
